...
namespace Marishop\Shoppingcart;
...
use Marishop\Shoppingcart\Contracts\Buyable;
use Marishop\Shoppingcart\Exceptions\UnknownModelException;
use Marishop\Shoppingcart\Exceptions\InvalidRowIDException;
use Marishop\Shoppingcart\Exceptions\CartAlreadyStoredException;
...
class Cart
{
     ...
     * @param array     $options
     * @param float     $taxrate
     * @return \Marishop\Shoppingcart\CartItem
     */
